...
- [ ] 맵 중간 버그 스폰 오류 (WaveSystem 카메라 기반 스폰)
- [ ] 이벤트 대화창 크기 확장 + 레이아웃 개선
- [ ] E3 클리어 무기 지급 버그 (보상 무기 시스템 연동)
- [ ] 게임 오버 화면 루프 + 재시작 잔상 제거
- [ ] TDD: 누적 테스트 GREEN
- [ ] 문서화: `blog/game-dev/draft-13-수정.md`

### Cycle 2 — 추가

- [ ] 이벤트 화면 구성 변경 (새 형식)
- [ ] 장선형 보스 픽셀 스프라이트 (48×48)
- [ ] NPC 픽셀 스프라이트 박진우·이한정 (32×32)
- [ ] 기본 버그 체력 조정 (2/3/4대 기준)
- [ ] 이벤트 몹 특수 공격 (E1: 느린 총알 / E3: 돌진) + 소환 수 제한
